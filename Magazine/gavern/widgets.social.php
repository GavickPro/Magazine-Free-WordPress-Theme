...
class GK_Social_Widget extends WP_Widget {
	...
	function widget($args, $instance) {
		...
		if ($fb_link !== '' || $twitter_link !== '' || $gplus_link !== '' || $rss_link !== '') {
			...
			echo $after_title;
			//
			if($twitter_link !== '') echo apply_filters('gk_social_twitter_link', '<a href="'.str_replace('&', '&amp;', $twitter_link).'" class="gk-icon-twitter"></a>');
			if($fb_link !== '') echo apply_filters('gk_social_fb_link', '<a href="'.str_replace('&', '&amp;', $fb_link).'" class="gk-icon-fb"></a>');
			if($pinterest_link !== '') echo apply_filters('gk_social_pinterest_link', '<a href="'.str_replace('&', '&amp;', $pinterest_link).'" class="gk-icon-pinterest"></a>');
			if($gplus_link !== '') echo apply_filters('gk_social_gplus_link', '<a href="'.str_replace('&', '&amp;', $gplus_link).'" class="gk-icon-gplus"></a>');
			// 
			echo $after_widget;
		}
